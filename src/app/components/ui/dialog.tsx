...
>(({ className, children, hideCloseButton, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      {!hideCloseButton && (
        <DialogPrimitive.Close className="absolute top-3 right-3 opacity-70 hover:opacity-100 transition-opacity focus:outline-none border-0 bg-transparent p-0 cursor-pointer disabled:pointer-events-none">
